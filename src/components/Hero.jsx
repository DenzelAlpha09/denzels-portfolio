...
export default function Hero() {
    return (
        <section>
            ...
            <div className='flex flex-col p-6 gap-[6px]'>
                <h2 className='font-medium text-2xl text-[#303841]'>Web and Mobile Developer</h2>
                <span className='flex gap-2 text-[#3A4750]'><i class="ri-map-pin-3-line"></i> Accra, Ghana</span>
                ...
                <p className='text-[#3A4750] text-[14px]'>If you want to know more about me, check my <span className='text-[#2185D5]'>about page</span></p>
            </div>
        </section>
    )
}